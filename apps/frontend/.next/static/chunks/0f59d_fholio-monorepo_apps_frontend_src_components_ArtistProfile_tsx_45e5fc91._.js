...
function ArtistProfile(param) {
    let { artistId = "17fa9d7f-04b6-46f7-b877-39606b1d0a0c", onNavigate } = param;
    _s();
    const { artist, isLoading, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$fholio$2d$project$2f$fholio$2d$monorepo$2f$apps$2f$frontend$2f$src$2f$lib$2f$hooks$2f$useArtists$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useArtist"])(artistId);
    if (!artist) {
        return null;
    }
...
_s(ArtistProfile, "u7nQ6zhXsfuWqbwLGlJPmRwGDEM=", false, function() {
    return [
